...
export default function Home() {
  ...
  const menuItems = [
    { label: "Discover", link: "/demo/home", ariaLabel: "Discover players" },
    { label: "Search", link: "/demo/search", ariaLabel: "Search" },
    { label: "Upload", link: "/demo/upload", ariaLabel: "Upload footage" },
    { label: "Features", link: "/demo#features", ariaLabel: "View features" },
  ];
          ...
          {(activeCategory === "all" || activeCategory === "strikers") && (
            <section>
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/demo/category/strikers" className="text-[#5B8DB8] font-semibold hover:text-[#4a7a9f] transition-colors flex items-center gap-1">
                  View all
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {loading ? (
                  ...
                  getPlayersByPosition('strikers').slice(0, 4).map((player) => (
                    <PlayerCard key={player.id} player={player} basePath="/demo" />
                  ))
                )}
              </div>
            </section>
          ...
          {(activeCategory === "all" || activeCategory === "midfielders") && (
            <section>
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/demo/category/midfielders" className="text-[#5B8DB8] font-semibold hover:text-[#4a7a9f] transition-colors flex items-center gap-1">
                  View all
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
          ...
          {(activeCategory === "all" || activeCategory === "defenders") && (
            <section>
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/demo/category/defenders" className="text-[#5B8DB8] font-semibold hover:text-[#4a7a9f] transition-colors flex items-center gap-1">
                  View all
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
          ...
          {(activeCategory === "all" || activeCategory === "goalkeepers") && (
            <section>
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/demo/category/goalkeepers" className="text-[#5B8DB8] font-semibold hover:text-[#4a7a9f] transition-colors flex items-center gap-1">
                  View all
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
