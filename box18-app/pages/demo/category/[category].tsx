  ...
  return (
    <div className={`${dmSans.variable} min-h-screen font-sans relative`}>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 bg-white rounded-t-3xl relative">
        <div className="mb-10">
          <Link href="/demo/home" className="inline-flex items-center gap-2 text-[#5B8DB8] font-semibold mb-4 hover:underline">
        ...
        {loading ? (
          ...
          <div className="text-center py-12 bg-gray-50 rounded-xl">
            ...
            <Link href="/demo/home" className="text-[#4A7FA8] font-semibold hover:underline">
              Return to discovery
            </Link>
          </div>
        ) : (
